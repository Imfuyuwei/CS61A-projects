...
def closer_city(lat, lon, city1, city2):
    ...
    'Bucharest'
    """
    chosen_city = make_city('chosen_city', lat, lon)
    if distance(city1, chosen_city) > distance(city2, chosen_city):
        return get_name(city2)
    elif distance(city1, chosen_city) < distance(city2, chosen_city):
