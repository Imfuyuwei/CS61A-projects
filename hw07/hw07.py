...
class MissManners:
    ...
    def ask(self, message, *args):
        ...
        operation = message[len(magic_word) :]
        if hasattr(self.obj, 'obj'):
            if message != 'please ask':
                return 'Thanks for asking, but I know not how to ' + operation + '.'
            else:
                return self.obj.ask(*args)
        if hasattr(self.obj, operation):
            return getattr(self.obj, operation)(*args)
        else:
            return 'Thanks for asking, but I know not how to ' + operation + '.'
